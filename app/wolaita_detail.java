...
public class wolaita_detail extends AppCompatActivity {

private Toolbar toolbar;
private ViewPager viewPager;
private TabLayout tabLayout;
private About_wolaita about;
private wolaita_matches matches;
private wolaita_squad squad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allocateactivitytitle(resources.getString(R.string.wolaita));
        about=new About_wolaita();
        squad= new wolaita_squad();
        matches= new wolaita_matches();
