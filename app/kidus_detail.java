...
public class kidus_detail extends AppCompatActivity {

private Toolbar toolbar;
private ViewPager viewPager;
private TabLayout tabLayout;
private About_kidus about;
private buna_matches matches;
private kidus_squad squad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allocateactivitytitle(resources.getString(R.string.kidus));
        about=new About_kidus();
        squad= new kidus_squad();
