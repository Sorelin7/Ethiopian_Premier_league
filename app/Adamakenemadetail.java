...
public class Adamakenemadetail extends AppCompatActivity {

private Toolbar toolbar;
private ViewPager viewPager;
private TabLayout tabLayout;
private About_adama about;
private adama_matches matches;
private Adama_squad squad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allocateactivitytitle(resources.getString(R.string.adama));
        about=new About_adama();
        squad= new Adama_squad();
        matches= new adama_matches();
