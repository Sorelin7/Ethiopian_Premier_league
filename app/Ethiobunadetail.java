...
public class Ethiobunadetail extends AppCompatActivity {

private Toolbar toolbar;
private ViewPager viewPager;
private TabLayout tabLayout;
private Aboutbunna about;
private buna_matches matches;
private bunna_squad squad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allocateactivitytitle(resources.getString(R.string.bunna));
        about=new Aboutbunna();
        squad= new bunna_squad();
        matches= new buna_matches();
